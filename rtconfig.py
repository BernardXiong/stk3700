...
if EFM32_BOARD == 'EFM32_G8XX_STK':
    ...
    EFM32_LCD =  'Mapped'
#    EFM32_LCD =  'Direct'
elif EFM32_BOARD == 'EFM32GG_STK3700':
    EFM32_FAMILY = 'Giant Gecko'
    EFM32_TYPE = 'EFM32GG990F1024'
    EFM32_LCD =  'Direct'
elif EFM32_BOARD == 'EFM32GG_3H':
    EFM32_FAMILY = 'Giant Gecko'
    EFM32_TYPE = 'EFM32GG980F1024'
    EFM32_LCD =  'Direct'	
...
if PLATFORM == 'gcc':
    ...
    elif EFM32_BOARD == 'EFM32GG_DK3750' or EFM32_BOARD == 'EFM32GG_STK3700':
    ...
    LFLAGS = ' --config rtthread-efm32.icf'
    LFLAGS += ' --semihosting' 
